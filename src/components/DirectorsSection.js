        ...
        <div className="row g-3">
          ...
          <div className="col-lg-6 col-md-6 col-12 director-card d-flex flex-column">
            ...
            <div className="content flex-grow-1 d-flex flex-column justify-content-between py-3 px-5">
              ...
              <span>
                Bhanvi Shivaya, a spiritual teacher and life coach, began in hotel management at 17 and later directed
                9 wellness centers. Recognizing the impact of mental coaching, she became a Reiki Grand Master, healing
                over 1500 globally. A licensed HRA practitioner, she founded a holistic Healing center with husband
                Vijay Gulati. Dedicated to charity, she aims to heal and help others worldwide.
              </span>
              <div className="know-more-button mt-3">
                <a href="/director-1">Know More</a>
              </div>
            </div>
          </div>
